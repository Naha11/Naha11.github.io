...
const translations = {
  ru: {
    ...
    hero_sub: 'через Telegram-ботов и автоматизацию',
    hero_desc: 'Клиенты записываются, заказы оформляются, данные собираются —\nвсё автоматически, пока вы занимаетесь бизнесом.\nГотовый бот за 1–2 дня. От 1 500 ₽.',
    btn_telegram: 'Получить бота за 1-2 дня', btn_kwork: 'Смотреть услуги',
    stat1: 'к продажам клиентов', stat2: 'дня — и бот работает', stat3: 'бот продаёт за вас',
    ...
    s3_title: 'Парсинг данных', s4_title: 'Сайт-визитка', s5_title: 'Discord-бот',
  ...
  en: {
    ...
    hero_sub: 'via Telegram bots & automation',
    hero_desc: 'Clients book, orders process, data collects —\nall automatically while you focus on business.\nReady bot in 1–2 days. From $15.',
    btn_telegram: 'Get your bot in 1-2 days', btn_kwork: 'View services',
    stat1: 'boost in client sales', stat2: 'days — bot is live', stat3: 'bot sells for you',
    ...
    s3_title: 'Data Parsing', s4_title: 'Landing Page', s5_title: 'Discord Bot',
  ...
  kz: {
    ...
    hero_sub: 'Telegram боттар және автоматтандыру арқылы',
    hero_desc: 'Клиенттер жазылады, тапсырыстар қабылданады, деректер жиналады —\nбәрі автоматты, сіз бизнесіңізбен айналысасыз.\nДайын бот 1–2 күнде. 7 500 ₸-ден.',
    btn_telegram: '1-2 күнде бот алу', btn_kwork: 'Қызметтерді қарау',
    stat1: 'сатылымдарға', stat2: 'күн — бот жұмыс істейді', stat3: 'бот сіз үшін сатады',
    ...
    s3_title: 'Деректер жинау', s4_title: 'Сайт-визитка', s5_title: 'Discord боты',
